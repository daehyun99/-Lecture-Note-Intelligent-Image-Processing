...
void EX1028_1()	//실습1 x에대한 그라디언트는 세로방향 선을 잘 표시함
{
	int height, width;
...
void EX1028_2()	//실습2 y에 대한 그라디언트는 가로방향 선을 잘 표시함
{
	int height, width;
	int** img = (int**)ReadImage("lena.png", &height, &width);
	int** img_out = (int**)IntAlloc2(height, width);
...
void EX1028_3() {	//실습3 x, y에 대한 그라디언트
	int height, width;
	int** img = (int**)ReadImage("lena.png", &height, &width);
	int** img_out = (int**)IntAlloc2(height, width);
...
void EX1028_6() {	//실습6 // 그라디언트 크기를 최대값으로 정규화
	int height, width;
	int** img = (int**)ReadImage("lena.png", &height, &width);
	int** img_out = (int**)IntAlloc2(height, width);
